    ...
    const fetchArticles = async () => {
      try {
        const res = await axios.get(
          "http://localhost:8080/api/article/category?category=nhóm máu anega",
          {
            headers: {
        ...
        const titlesToExtract = [
          "Người có nhóm máu A- có thể nhận máu từ nhóm nào?",
          "Ai có thể nhận máu từ người mang nhóm máu A-?",
        ];
